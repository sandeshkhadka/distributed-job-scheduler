...
The class diagram (Figure~\ref{fig:class-analysis}) shows the main classes and their relationships in the Distributed Job Scheduler system.

\begin{figure}[htbp]
	\centering
	\figimg{figures/class-analysis.png}
	\caption{Analysis-level class diagram showing key classes and relationships}
