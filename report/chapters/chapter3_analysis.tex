...
The scheduler-side classes identified during analysis are:
...
The worker-side classes identified during analysis are:
...
\textbf{Job Lifecycle (Figure~\ref{fig:sequence-job-lifecycle}):}
\begin{enumerate}
...
\textbf{Worker Registration (Figure~\ref{fig:sequence-worker-registration}):}
\begin{enumerate}
