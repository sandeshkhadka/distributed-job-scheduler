...
\begin{enumerate}
    \item Design and implement a centralized gRPC-based scheduler with pluggable job selection strategies (FCFS, SJF, Adaptive) for intelligent job distribution across registered worker nodes.
